...
const Index = () => {
    return (
        <>
            <Navbar />
            <div className="text-5xl mb-8 Gilroy-ExtraBold ltr:text-left rtl:text-right" style={{ padding: "2rem 4rem" }}>
                <div className="text-5xl mb-8 Gilroy-ExtraBold ltr:text-left rtl:text-right">
                    <h1>Privacy Policy for IHTIRAF</h1>
                </div>
                <div className="Gilroy-Bold text-lg mb-8 ltr:text-left rtl:text-right" style={{ textAlign: "start" }}>
                    <p>
                        At clarify.com, accessible from https://clarify.com, one of our main
                        priorities is the privacy of our visitors. This Privacy Policy document
                        contains types of information that are collected and recorded by
                        clarify.com and how we use it.
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        and/or collect in clarify.com. This policy is not applicable to any
                        information collected offline or via channels other than this website.
                    </p>
                    <h2 className="text-3xl mt-4">Consent</h2>
                    <p>
                        By using our website, you hereby consent to our Privacy Policy and agree
                        to its terms.
                    </p>
                    <h2 className="text-3xl mt-4">Information we collect</h2>
                    <p>
                    ...
                    <h2 className="text-3xl mt-4">How we use your information</h2>
                    ...
                    <h2 className="text-3xl mt-4">Log Files</h2>
                    <p>
                        clarify.com follows a standard procedure of using log files. These files
                    ...
                    <h2 className="text-3xl mt-4">Cookies and Web Beacons</h2>
                    <p>
                        Like any other website, clarify.com uses 'cookies'. These cookies are
                    ...
                    <h2 className="text-3xl mt-4">Advertising Partners Privacy Policies</h2>
                    <p>
                        You may consult this list to find the Privacy Policy for each of the
                        advertising partners of clarify.com.
                    </p>
                    <p>
                        Third-party ad servers or ad networks uses technologies like cookies,
                        JavaScript, or Web Beacons that are used in their respective
                        advertisements and links that appear on clarify.com, which are sent
                    ...
                    <p>
                        Note that clarify.com has no access to or control over these cookies that
                        are used by third-party advertisers.
                    </p>
                    <h2 className="text-3xl mt-4">Third Party Privacy Policies</h2>
                    <p>
                        clarify.com's Privacy Policy does not apply to other advertisers or
                    ...
                    <h2 className="text-3xl mt-4">GDPR Data Protection Rights</h2>
                    <p>
                    ...
                    <h2 className="text-3xl mt-4">Children's Information</h2>
                    <p>
                    ...
                    <p>
                        clarify.com does not knowingly collect any Personal Identifiable

...
const Index = () => {
    return (
        <>
            <Navbar />
            <div className="text-5xl mb-8 Gilroy-ExtraBold ltr:text-left rtl:text-right" style={{paddingTop: "2rem"}}>
                <h1>Terms and Conditions</h1>
            </div>
            <div className="Gilroy-Bold text-lg mb-8 ltr:text-left rtl:text-right" style={{ textAlign: "start", padding: "2rem 4rem"}}>
                <h1>Welcome to Clarify!</h1>
                <p>
                    These terms and conditions outline the rules and regulations for the use
                    of IHTIRAF's Website, located at https://clarify.com.
                </p>
                <p>
                    By accessing this website we assume you accept these terms and conditions.
                    Do not continue to use Clarify if you do not agree to take all of the
                ...
                <p>
                    We employ the use of cookies. By accessing Clarify, you agreed to use
                    cookies in agreement with the IHTIRAF's Privacy Policy.
                </p>
                <p>
                ...
                <p>
                    Unless otherwise stated, IHTIRAF and/or its licensors own the intellectual
                    property rights for all material on Clarify. All intellectual
                    property rights are reserved. You may access this from Clarify for
                    your own personal use subjected to restrictions set in these terms and
                    conditions.
                </p>
                <p>You must not:</p>
                <ul className="list-disc list-inside">
                    <li>Republish material from Clarify</li>
                    <li>Sell, rent or sub-license material from Clarify</li>
                    <li>Reproduce, duplicate or copy material from Clarify</li>
                    <li>Redistribute content from Clarify</li>
                </ul>
                <p>This Agreement shall begin on the date hereof.</p>
                <p>
                    Parts of this website offer an opportunity for users to post and exchange
                    opinions and information in certain areas of the website. IHTIRAF does not
                    filter, edit, publish or review Comments prior to their presence on the
                    website. Comments do not reflect the views and opinions of IHTIRAF,its
                    ...
                    applicable laws, IHTIRAF shall not be liable for the Comments or for any
                ...
                <p>
                    IHTIRAF reserves the right to monitor all Comments and to remove any
                ...
                <p>
                    You hereby grant IHTIRAF a non-exclusive license to use, reproduce, edit
                ...
                <p>
                    ...
                    hyperlink compensates the absence of IHTIRAF; and (d) the link is in the
                ...
                <p>
                    ...
                    e-mail to IHTIRAF. Please include your name, your organization name,
                ...
                <p>
                    No use of IHTIRAF's logo or other artwork will be allowed for linking
